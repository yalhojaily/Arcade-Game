...
Player.prototype.update = function(enemies) {
    for (enemy of enemies){
        if ((this.x >= enemy.x - 70 && this.x <= enemy.x + 70) && (this.y >= enemy.y - 70 && this.y <= enemy.y + 70)){
           this.x = 200;
           this.y = 350;
        }
    }
...
var allEnemies = [new Enemy(70), new Enemy(140), new Enemy(210), new Enemy(190)];
